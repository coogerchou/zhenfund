...
#SECRET_KEY = '7xc0$-j*e5v%e0x^dtt(dy(oa64g7cm@5!+iin*xzx47^g@+fd'
SECRET_KEY = os.environ.get('SECRET_KEY','7xc0$-j*e5v%e0x^dtt(dy(oa64g7cm@5!+iin*xzx47^g@+fd')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['zhenfund.herokuapp.com']
...
#where staticfiles goes to; changing the path to the folder
